...
export const ReportsPage = () => {
  ...
  const previousMonthCost =
    mockMonthlySpending[mockMonthlySpending.length - 2].amount;
  const currentMonthCost =
    mockMonthlySpending[mockMonthlySpending.length - 1].amount;
          ...
          <div className="space-y-4">
            <div className="rounded-[8px] border-[1.5px] border-border bg-card p-4">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Your 'Software' category spending has increased by 15% this
                month, primarily due to Adobe Creative Cloud. Consider reviewing
                if all features are being utilized.
              </p>
            </div>
            <div className="rounded-[8px] border-[1.5px] border-border bg-card p-4">
              <h4 className="font-semibold">Potential Savings Detected</h4>
              <p className="mt-2 text-sm text-muted-foreground">
                You're subscribed to both Spotify and YouTube Premium. YouTube
                Premium includes YouTube Music. You could save $10.99/month by
                canceling Spotify.
              </p>
            </div>
          </div>
